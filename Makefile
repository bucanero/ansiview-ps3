...
ifdef DEBUGLOG
CFLAGS		+=	-DDEBUG_ENABLE_LOGGING
endif
#---------------------------------------------------------------------------------
# any extra libraries we wish to link with the project
#---------------------------------------------------------------------------------
LIBS	:=	-ltiny3d -lfreetype -lgcm_sys -lrsx -lsysutil -lio -lnet -lsysmodule \
			-lssl -lhttp -lhttputil -lzip -lz -ldbglogger -lansilove -lm -lmikmod \
			-laudio -lpngdec -lpng -lcurl -lpolarssl -lnet
